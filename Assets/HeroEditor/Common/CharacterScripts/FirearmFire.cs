...
namespace Assets.HeroEditor.Common.CharacterScripts
{
    ...
    /// </summary>
    public class FirearmFire : NetworkBehaviour
    {
        ...
        public float _randomSpeed = 0f;
        public Vector3 _curSpread; 
        ...
        private void CreateBullet(float dur) // TODO: Preload and caching prefabs is recommended to improve game performance
        {
            ...
            for (var i = 0; i < iterations; i++)
            {
                ...
                _curSpread = spread;
                _randomSpeed = Random.Range(0.85f, 1.15f);
                bullet.transform.localPosition = Vector3.zero;
                bullet.transform.localRotation = Quaternion.identity;
                bullet.playerShooting = Character;
                bullet.weapon = this; 
        ...
        {
            Debug.Log("whaaa");
            double time_passed = NetworkTime.time - networkTime;
            if (SceneManager.GetActiveScene().name.Contains("CharacterEditor")) return; // Don't create bullets in editor scene
            ...
            for (var i = 0; i < iterations; i++)
            {
                ...
                bullet.Initialize((float)time_passed);
        ...
        [ClientRpc]
        private void RPCFire(double networkTime)
        {
