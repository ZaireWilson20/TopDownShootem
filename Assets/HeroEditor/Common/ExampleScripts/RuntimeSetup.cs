...
namespace Assets.HeroEditor.Common.ExampleScripts
{
	...
	public class RuntimeSetup : MonoBehaviour
	{
		...
		{
			var head = Character.SpriteCollection.Head.Single(i => i.Name == headName && i.Collection == headCollection);
			var body = Character.SpriteCollection.Body.Single(i => i.Name == bodyName && i.Collection == bodyCollection);
		...
		{
			var entry = Character.SpriteCollection.MeleeWeapon1H.Single(i => i.Name == sname && i.Collection == collection);
		...
		{
			var entry = Character.SpriteCollection.MeleeWeapon2H.Single(i => i.Name == sname && i.Collection == collection);
		...
		{
			var sprites = Character.SpriteCollection.Bow.Single(i => i.Name == sname && i.Collection == collection).Sprites;
		...
		{
			var sprites = Character.SpriteCollection.Firearms1H.Single(i => i.Name == sname && i.Collection == collection).Sprites;
		...
		{
			var sprite = Character.SpriteCollection.Shield.Single(i => i.Name == sname && i.Collection == collection).Sprite;
		...
		{
			var sprites = Character.SpriteCollection.Armor.Single(i => i.Name == sname && i.Collection == collection).Sprites;
		...
		{
			var sprite = Character.SpriteCollection.Helmet.Single(i => i.Name == sname && i.Collection == collection).Sprite;
