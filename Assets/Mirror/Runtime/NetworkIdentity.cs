    ...
    public sealed class NetworkIdentity : MonoBehaviour
    {
        ...
        void OnValidate()
        {
            ...
            if (_allowChildrenBehaviours)
            {
                ...
                foreach(NetworkIdentity net in netIds)
                {
                    if(net.gameObject != gameObject)
                    {
                        //Debug.LogError("Child object " + net.gameObject.name + " cannot have child Network Identities when using AllowChildrenBehaviours");
                    }
                }
            }
#endif      
